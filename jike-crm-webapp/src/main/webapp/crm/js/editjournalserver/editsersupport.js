function supportHtml(){
	...
	suportHtml+='<div class="container-fluid">';
		suportHtml+='<div class="aftersaleObjwap">';
			...
			suportHtml+='</div>';
		suportHtml+='</div>';
		suportHtml+='<div class="sign-wap supportLabel servSupportLabel">';
			...
			suportHtml+='<div class="form-group row">';
				...
				suportHtml+='<div class="col-sm-1">';
					suportHtml+='<input type="text" class="form-control inp1 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
				suportHtml+='</div>';
			...
			suportHtml+='<div class="form-group row ">';
				...
				suportHtml+='<div class="col-sm-1">';
					suportHtml+='<input type="text" class="form-control inp2 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
				suportHtml+='</div>';
				suportHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
			suportHtml+='</div>';
			suportHtml+='<div class="form-group row">';
				...
				suportHtml+='<div class="col-sm-1">';
					suportHtml+='<input type="text" class="form-control inp3 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4" />';
				suportHtml+='</div>';
				suportHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
			suportHtml+='</div>';
			suportHtml+='<div class="form-group row">';
				suportHtml+='<label class="col-sm-2">产品演示介绍</label>';
				suportHtml+='<div class="col-sm-1">';
					suportHtml+='<input type="text" class="form-control inp4 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
				suportHtml+='</div>';
				suportHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
			suportHtml+='</div>';
			suportHtml+='<div class="form-group row">';
				suportHtml+='<label class="col-sm-2">产品介绍讲解，简单操作演示</label>';
				suportHtml+='<div class="col-sm-1">';
					suportHtml+='<input type="text" class="form-control inp5 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
				suportHtml+='</div>';
				suportHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
			suportHtml+='</div>';
