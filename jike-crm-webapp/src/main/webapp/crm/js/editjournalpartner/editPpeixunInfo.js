...
//			trainiHtml+='</div>';
		...
		trainiHtml+='<div class="trainobject-wap clearfix">';
			...
			trainiHtml+='<div class="col-sm-6">';
				trainiHtml+='<input type="text" class="form-control trainObjstate" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
			trainiHtml+='</div>';
		trainiHtml+='</div>';
		trainiHtml+='</div>';
		trainiHtml+='<div class="sign-wap" style="padding:0 5%;">';
			...
			trainiHtml+='<div class="col-sm-6">';
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp1 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
				...
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp2 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
				...
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp3 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp4 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp5 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row pull-right">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp6 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
			trainiHtml+='</div>';
			trainiHtml+='<div class="col-sm-6">';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp7 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp8 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp9 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp10 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp11 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
				trainiHtml+='<div class="form-group row">';
					...
					trainiHtml+='<div class="col-sm-3">';
						trainiHtml+='<input type="text" class="form-control inp12 inpitem" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
					trainiHtml+='</div>';
					trainiHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
				trainiHtml+='</div>';
			trainiHtml+='</div>';
			trainiHtml+='<p class="col text-right" style="font-size:13px;margin-right:10%;">*培训内容至少填写一项</p>';
