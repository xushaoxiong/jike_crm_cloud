	...
	vFhtml+='<div class="container-fluid">';
		vFhtml+='	<div class="plan-wap">';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">所属拜访计划</label>';
				vFhtml+='	<div class="col-sm-4">';
					vFhtml+='	<span class="form-control visPlan"/></span>';
				vFhtml+='	</div>';
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">拜访人姓名</label>';
				vFhtml+='	<div class="col-sm-3">';
					vFhtml+='	<input type="text" value="" placeholder="" class="form-control visName"/>';
				vFhtml+='	</div>';
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">拜访人职位</label>';
				vFhtml+='	<div class="col-sm-2">';
...
//					vFhtml+='	<input type="text" value="" placeholder="" class="form-control visPosit"/>';
				vFhtml+='	</div>';
				vFhtml+='	<div class="col-sm-2" style="padding-left: 0;">';
					vFhtml+='	<input type="text" placeholder="" class="form-control otherCont" />';
				vFhtml+='	</div>';
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">拜访人联系方式</label>';
				vFhtml+='	<div class="form-inline col-sm-6 contact-wap" style="padding:0;">';
			...
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">拜访地址</label>';
				vFhtml+='	<div id="city" class="form-inline col-sm-6" style="padding:0;">';
	            	vFhtml+='	<div class="col-sm-2">';
					...
					vFhtml+='     </div>';
					vFhtml+='    <div class="col-sm-6">';
					    vFhtml+='	<input type="type" class="form-control detailadrs"/>';
					vFhtml+='    </div>';    
				vFhtml+='	</div>';
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">采购预算</label>';
				vFhtml+='	<div class="col-sm-2">';
			...
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1">拜访目的</label>';
				vFhtml+='	<div class="col-sm-2">';
			...
			vFhtml+='	</div>';
			vFhtml+='	<div class="form-group row">';
				vFhtml+='	<label class="col-sm-1"><span class="col">*</span>拜访详情</label>';
				vFhtml+='	<div class="col-sm-4">';
					vFhtml+='	<textarea class="form-control purpTextare" ></textarea>';
				vFhtml+='	</div>';
			vFhtml+='	</div>';
		vFhtml+='	</div>';
		vFhtml+='	<div class="planbtn-group col-sm-4 text-center">';
