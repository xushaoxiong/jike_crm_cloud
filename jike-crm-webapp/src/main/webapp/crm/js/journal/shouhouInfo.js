	...
	aftSealtHtml+='<div class="container-fluid">';
		...
		aftSealtHtml+='<div class="sign-wap afterSaleLabel">';
			...
			aftSealtHtml+='<div class="form-group row">';
				...
				aftSealtHtml+='<div class="col-sm-1">';
					aftSealtHtml+='<input type="text" class="form-control aftSelInp aftSelInp1" onkeyup="PosiintegerNum(this)" maxlength="3" />';
				aftSealtHtml+='</div>';
			...
			aftSealtHtml+='<div class="form-group row ">';
				...
				aftSealtHtml+='<div class="col-sm-1">';
					aftSealtHtml+='<input type="text" class="form-control aftSelInp aftSelInp4" onkeyup="PosiintegerNum(this)" maxlength="3"/>';
				aftSealtHtml+='</div>';
			...
			aftSealtHtml+='<div class="form-group row ">';
				...
				aftSealtHtml+='<div class="col-sm-1">';
					aftSealtHtml+='<input type="text" class="form-control aftSelInp aftSelInp6" onkeyup="PosiintegerNum(this)" maxlength="3"/>';
				aftSealtHtml+='</div>';
				aftSealtHtml+='<span style="line-height: 34px;">&nbsp;&nbsp;次</span>';
			aftSealtHtml+='</div>';
			aftSealtHtml+='<div class="planbtn-group row">';
				aftSealtHtml+='<button class="btn btn-primary aftSealConfirm" style="padding:6px 40px;margin-left:165px;" onclick="aftSealConfirm()">提交</button>';
...
//获取试用结果信息
	function aftSealInfo(boCustomerService){
		...
		if(boCustomerService.cooperativePartnerSchoolId==""){
			boCustomerService.schoolName="";
		}else{
