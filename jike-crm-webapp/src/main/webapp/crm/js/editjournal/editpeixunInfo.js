		...
		trainiHtml+='<div class="sign-wap">';
			...
			trainiHtml+='<div class="form-group row">';
				...
				trainiHtml+='<div class="col-md-1 col-sm-1">';
					trainiHtml+='<input type="text" class="form-control trainPersonNumb" onkeyup="PosiintegerNum(this)" maxlength="4" />';
				trainiHtml+='</div>';
			...
			trainiHtml+='<div class="form-group row ">';
				...
				trainiHtml+='<div class="col-md-1 col-sm-1">';
					trainiHtml+='<input type="text" class="form-control trainNumb" onkeyup="PosiintegerNum(this)" maxlength="4"/>';
				trainiHtml+='</div>';
