						...
						signHtml+='<div class="areaitem">';
							signHtml+='<div class="col-md-9 col-sm-9 earelist assmentaddr" ty="0" style="padding:0;">';
							    ...
							    signHtml+='<div class="col-md-4 col-sm-4">';
								 ...
								 signHtml+='</div>';   
							signHtml+='</div>';
							signHtml+='<button class="btn btn-primary addeare" style="margin-left:5px;" onclick="addeare()">添加代理区域</button>';
						signHtml+='</div>';
					signHtml+='</div>';
				signHtml+='</div>';
			signHtml+='</div>';
	...
	eareHtml+='<div class="areaitem" style="margin-bottom:15px;">';
		eareHtml+='<div class="col-md-9 col-sm-9 earelist" ty='+earaN+'>';
		    ...
		    eareHtml+='<div class="col-md-4 col-sm-4">';
			 ...
			 eareHtml+='</div>';   
		eareHtml+='</div>';
		eareHtml+='<button class="btn btn-primary deleare" style="margin-left:5px;" onclick="deleare($(this))">删除此区域</button>';  	
	eareHtml+='</div>';
...
//	$('.journaConfirm').click(function(){
	function signpanerjournaConfirm(){	
		signInfo(boSign);
		logDateF(logData);
